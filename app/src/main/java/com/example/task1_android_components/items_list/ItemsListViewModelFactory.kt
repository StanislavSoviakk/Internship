...
class ItemsListViewModelFactory(
    private val preferencesManager: PreferencesManager, private val reducer: ItemsListReducer
) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        @Suppress("UNCHECKED_CAST") if (modelClass.isAssignableFrom(ItemsListViewModel::class.java)) {
